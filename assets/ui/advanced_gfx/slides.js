...
font.setAttribute("src", "/assets/ui/graphic_support/numeric.png");
signs = {
...
function notOperaFix() {
	...
	if ((isIE && notIE7) && document.styleSheets && document.styleSheets[0]) {
		document.styleSheets[0].addRule('img', 'behavior: url(/assets/ui/graphic_support/iepngfix.htc)');
		document.styleSheets[0].addRule('div', 'behavior: url(/assets/ui/graphic_support/iepngfix.htc)');
		document.styleSheets[0].addRule('.slide', 'behavior: url(/assets/ui/graphic_support/iepngfix.htc)');
	}
}
...
function createProgress() {
	...
	im.src = "/assets/ui/graphic_support/blank.gif?" + new Date().valueOf();
...
if(!isIE && !isOp) {
	document.write('<script type="text/javascript" src="/assets/ui/audio_support/soundmanager2.js"></script>');
	if(typeof soundManager!="undefined") {
		var allMetas = document.getElementsByTagName('meta');
		for (var i = 0; i< allMetas.length; i++) {
